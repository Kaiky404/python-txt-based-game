...
def main_choice_loop():
    ...
    print(f"Você é {C.MAGENTA}{player.char}{C.NORMAL}, um jovem de 19 anos que vive em um {C.RED}vilarejo conectado ao mundo exterior por um cruzamento famoso.")
    print(F"Seus pais são os fazendeiros locais, {C.RED}José {C.NORMAL}e {C.RED}Maria{C.NORMAL}. Eles são {C.RED}filhos dos fundadores do vilarejo{C.NORMAL}. Você não tem nenhum outro parente.")
