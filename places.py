...
def main_choice_loop():
    while True:
        ...
        if MainChoice == "1":
            ...
            damage(101, "standing up too quickly")
            heal(5, "morning stretch")
            add_item("Well-used dark tanktop")
            remove_item("Well-used dark tanktop")
            add_item("Well-used dark tanktop")
            equip_item("Well-used dark tanktop")
            item_unequipped("Well-used dark tanktop", bonus)
            print()
